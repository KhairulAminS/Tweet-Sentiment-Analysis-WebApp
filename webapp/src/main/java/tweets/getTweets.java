...
public class getTweets {
    ...
    private static final String bearerToken = "YOUR BEARER TOKEN";
    static String streamURL = "https://api.twitter.com/2/tweets/search/stream?tweet.fields=created_at,text&expansions=author_id&&user.fields=id,name,username,profile_image_url";
...
//    static String sampleURL = "https://api.twitter.com/2/tweets/sample/stream?&expansions=author_id";
    ...
    public static void getStream() throws InterruptedException, IOException {
